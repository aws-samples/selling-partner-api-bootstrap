...
public class EventSubscription implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    // From cdk.
    public static final String SQS_ARN = System.getenv("SQS_ARN");
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context){
        ...
        final List<SellerSecretsVO> sellerSecretsVOs = Helper.getSellerSecretsVOS();

        logger.info("going to subscribe for number of sellers: " + sellerSecretsVOs.size());

        final Boolean[] isError = {false};
        sellerSecretsVOs.forEach(
                secretsVO -> {
                    try {
     ...
     */
    private static void subscribe(SellerSecretsVO secretsVO) throws Throwable {
        ...
        final ApiProxy<CreateDestinationResponse> createDestinationApi =
                new ApiProxy<>(new EventCreateDestination(Helper.buildNotificationGrantLessApi(secretsVO)));
        ...
        final ApiProxy<CreateSubscriptionResponse> createSubscriptionResponseApiProxy =
                new ApiProxy<>(new EventCreateSubscription(Helper.buildNotificationApi(secretsVO)));

...
public class FbaInventoryApi {
    ...
    public static class Builder extends SPAPIBuilder<FbaInventoryApi> {

        @Override
        public FbaInventoryApi build(SellerCredentials jsonSellerSecrets) throws NoSuchFieldException, IllegalAccessException {
    ...
    public static FbaInventoryApi buildFbaInventoryApi(SellerCredentials jsonSellerSecrets) throws NoSuchFieldException, IllegalAccessException {
